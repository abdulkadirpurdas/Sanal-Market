...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 30 May 2019, 22:56:17
...
CREATE TABLE `firma` (
  ...
  `firma_hakkinda` varchar(1000) COLLATE utf8_unicode_ci NOT NULL,
  `firma_iletisim` varchar(250) COLLATE utf8_unicode_ci NOT NULL,
...
(11, 'KARACA HOLDING', 'Yunus Karaca', 'aaaaaaaaaaaaaa', 'ssssssssssssssssssss', 'upload/857012.png'),
(13, 'GÜLLÜ PAZARLAMA', 'İsmail Güllü ', 'Kayseri\'nin yeni ateşi Güllü Pazarlama olarak piyasaya yeni bir akım olarak doğduk.', 'Kime sorsan gösterir.', 'upload/2152.jpg'),
(14, 'Şirdan A.Ş', 'Osman ONAY', 'şirdan ve kebap çeşitlerimiz mevcuttur.', 'firmamız kiremithanede kurulmuş olup tüm adanaya hizmet vermektedir.', 'upload/282818.jpg'),
(15, 'İncirlik AVM', 'Muhammed Salih Aydın ', 'aa', 'ss', 'upload/467692.jpg');
...
(1, 'Yunus Karaca', 'htckdr25@gmail.com', 'deneme', 'merhaba kadir bu mesaj sana deneme için iletildi.', '2019-04-23 01:24:47', 0),
(2, 'Yunus Karaca', 'htckdr25@gmail.com', 'iş basvurusu', 'Lorem Ipsum, dizgi ve baskı endüstrisinde kullanılan mıgır metinlerdir. Lorem Ipsum, adı bilinmeyen bir matbaacının bir hurufat numune kitabı oluşturmak üzere bir yazı galerisini alarak karıştırdığı 1500\'lerden beri endüstri standardı sahte metinler ', '2019-04-23 02:34:13', 0),
(3, 'Abdulkadir Purdaş', 'ynskrc82@gmail.com', 'bilgilendirme', 'merhabalar yunus bey geliştirmiş olduğunuz yazilim üzerine bazı açıklar bulunmaktadır. Bunun için gerekli önlemleri alınız.<br>', '2019-05-12 02:38:00', 1);
...
(4, 5, 8, 'Kapıda Ödeme', 's', 'yunus karaca', 1),
(5, 13, 7, 'Kapıda Ödeme', 'aa', 'kardes', 0);
...
CREATE TABLE `sanalkart` (
  ...
  `sanalkart_no` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `sanalkart_kullaniciid` int(11) NOT NULL,
  `sanalkart_firmaid` int(11) NOT NULL,
...
(43, 49, 1, 5, '1', 7, ' ', 'Şirdan A.Ş'),
(44, 50, 1, 5, '1', 1, ' ', 'Şirdan A.Ş'),
(45, 53, 1, 13, '1', 6, ' ', 'Şirdan A.Ş'),
(46, 54, 1, 13, '1', 1, ' ', 'Şirdan A.Ş');
...
CREATE TABLE `sube` (
  ...
  `sube_reyon` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
...
(1, '1.sube', 'upload/975972.png', 'a', '1', 3);
...
(9, 'KARACA HOLDING', 'Portakal', '10', 'adana yetişmiş üründür', 'portakal kabukları ile güzel kek ve portakal suyu yapılabilir', 5, 'upload/900179.jpg', 10, 0),
(10, 'KARACA HOLDING', 'Çilek', '10', '', '', 5, 'upload/152718.jpg', 10, 0),
(13, 'KARACA HOLDING', 'Soğan', '11', '', '', 5, 'upload/871836.jpg', 10, 0),
...
(22, 'KARACA HOLDING', 'Siyah Zeytin', '21', '', '', 5, 'upload/921727.jpg', 10, 0),
(23, 'KARACA HOLDING', 'Yeşil Zeytin', '21', '', '', 5, 'upload/204342.jpg', 10, 0),
(24, 'KARACA HOLDING', 'Peynir', '17', '', '', 5, 'upload/681268.jpg', 10, 0),
...
(29, 'KARACA HOLDING', 'Sprite', '39', '', '', 5, 'upload/642881.jpg', 10, 0),
(30, '', 'Çay', '41', '', '', 5, 'upload/694587.jpg', 10, 0),
(31, '', 'Su', '43', '', '', 5, 'upload/848613.jpg', 10, 0),
(32, '', 'Maden Suyu', '44', '', '', 5, 'upload/528262.jpg', 10, 0),
(33, '', 'Sabun', '49', '', '', 5, 'upload/737832.jpg', 10, 0),
(34, '', 'Şampuan', '49', '', '', 5, 'upload/979335.jpg', 10, 0),
(35, '', 'Çamaşır Suyu', '47', '', '', 5, 'upload/797080.jpg', 10, 0),
(36, '', 'Bulaşık Deterjanı', '46', '', '', 5, 'upload/455313.jpg', 10, 0),
(37, '', 'Oje', '61', '', '', 5, 'upload/253401.jpg', 10, 0),
(38, '', 'Diş Macunu', '53', '', '', 5, 'upload/834818.jpg', 10, 0),
(39, '', 'Diş Fırçası', '53', '', '', 5, 'upload/8456.jpg', 10, 0),
(40, '', 'Deodorant', '59', '', '', 5, 'upload/998394.jpg', 10, 0),
(41, '', 'Oyuncak Araba', '66', '', '', 5, 'upload/680651.jpg', 10, 0),
(42, '', 'Oyuncak Araba', '66', '', '', 5, 'upload/403774.jpg', 10, 0),
(43, '', 'Bebek Bezi', '64', '', '', 5, 'upload/279196.jpg', 10, 0),
(44, '', 'Emzik', '63', '', '', 5, 'upload/761364.jpg', 10, 0),
(45, '', 'Huawei', '73', '', '', 5, 'upload/580877.jpg', 10, 0),
(46, '', 'asus', '73', '', '', 5, 'upload/282818.jpg', 10, 0),
(47, '', 'Kalem', '71', '', '', 5, 'upload/841784.jpg', 10, 0),
(48, '', 'Çadır', '70', '', '', 5, 'upload/783831.jpg', 10, 0),
(49, 'Şirdan A.Ş', 'Çilek', '10', '', '', 7, 'upload/152718.jpg', 7, 1),
(50, 'Şirdan A.Ş', 'Makarna', '25', 'Ketılda yaparsanız daha farklı bir tad alacaksınız.', 'ketıla 1.5 litre suyu at makrnayı da koy kaynat.', 1, 'upload/224144.jpg', 7, 0),
(51, 'Şirdan A.Ş', 'Tavuk', '13', '', '', 10, 'upload/312151.jpg', 8, 0),
(52, 'Şirdan A.Ş', 'Yeşil Zeytin', '21', '', '', 15, 'upload/204342.jpg', 9, 0),
(53, 'Şirdan A.Ş', 'Dondurulumuş Mısır', '33', '', '', 6, 'upload/338499.jpg', 9, 0),
(54, 'Şirdan A.Ş', 'Soda', '44', '', '', 1, 'upload/528262.jpg', 9, 0),
(55, 'İncirlik AVM', 'Sprite', '39', '', '', 3, 'upload/642881.jpg', 10, 0),
(56, 'İncirlik AVM', 'Sabun', '49', '', '', 1, 'upload/737832.jpg', 10, 0),
(57, 'KARACA HOLDING', 'Çamaşır Suyu', '45', '', '', 5, 'upload/325753.jpg', 10, 0);
...
(3, 'Yunus Karaca', 'ynskrc82@gmail.com', '1', '11111111111', 'KARACA HOLDING', '46', '636', 'Firma', '1', ''),
(5, 'Salim Can KURTGÖZ', 'slmcn@gmail.com', '1', '11111111111', ' ', '1', '1', 'Kullanıcı', '1', ''),
(6, 'İsmail Güllü ', 'il38glll@gmail.com', '1', '11111111111', 'GÜLLÜ PAZARLAMA', '38', '523', 'Firma', '1', ''),
(7, 'Osman ONAY', 'onay0121@gmail.com', '1', '11111111111', 'Şirdan A.Ş', '1', '11', 'Firma', '1', ''),
(11, 'Muhammed Salih Aydın ', 'mami@gmail.com', '1', '11111111111', 'İncirlik AVM', '1', '10', 'Firma', '1', ''),
(12, 'emre karaca', 'emre@gmail.com', '1', '11111111111', ' ', '46', '636', 'Kullanıcı', '1', ''),
(13, 'servet ', 's@gmail.com', '1', '11111111111', ' ', '1', '1', 'Kullanıcı', '1', '');
...
(4, 'Admin cCc', 'Alllah\'tan site sahibine beleş yoksa çok pahalı herşey.', 9, 0, '2019-04-25 00:25:38');
...
ALTER TABLE `sanalkart`
  ...
  ADD KEY `sanalkart_kullaniciid` (`sanalkart_kullaniciid`),
  ADD KEY `sanalkart_firmaid` (`sanalkart_firmaid`);
...
--
ALTER TABLE `indirim`
  MODIFY `indirim_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
...
--
ALTER TABLE `odeme`
  MODIFY `odeme_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- Tablo için AUTO_INCREMENT değeri `sanalkart`
--
ALTER TABLE `sanalkart`
  MODIFY `sanalkart_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- Tablo için AUTO_INCREMENT değeri `sepet`
--
ALTER TABLE `sepet`
  MODIFY `sepet_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;

--
-- Tablo için AUTO_INCREMENT değeri `sube`
--
ALTER TABLE `sube`
  MODIFY `sube_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- Tablo için AUTO_INCREMENT değeri `urun`
--
ALTER TABLE `urun`
  MODIFY `urun_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;
